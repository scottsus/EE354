...
add wave -noupdate /ee354_GCD_CEN_tb_v/Clk                                              # add this var into the wave window
...
configure wave -timelineunits ps                # zoom into the ps level
update
WaveRestoreZoom {0 ps} {315 ns}                 # zoom from 0ps to 315 ns
