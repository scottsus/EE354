...
HD_PWD='C:/Labs/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ee354_detour_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ee354_detour_top.tcl -notrace
