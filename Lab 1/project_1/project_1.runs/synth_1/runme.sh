...
HD_PWD='C:/Labs/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ee354_detour_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ee354_detour_top.tcl
