...
HD_PWD='C:/Users/scottsus/EE 354/Lab 8/Picoblaze_Design_Steps_Demo/synthesis/picoblaze_demo/picoblaze_demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log picoblaze_demo_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source picoblaze_demo_top.tcl
